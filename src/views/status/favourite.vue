...
export default {
  ...
  computed: {
    ...mapGetters({
      statuses: "favourite_statuses",
      newStatuses: "favourite_newStatuses",
      currentPage: 'favourite_currentPage',
      lastPage: "favourite_LastPage",
      siteInfo: "siteInfo"
    })
  },
  data() {
  ...
  methods: {
    ...mapActions({
      getStatusData: 'favourite_getStatus',
      refreshStatusData: 'favourite_refreshStatus',
    }),
    refreshStatus() {
