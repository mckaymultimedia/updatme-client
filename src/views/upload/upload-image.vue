  ...
  <main class="justify-center mx-auto mt-3 mb-4 sm:w-4/5 md:w-3/4 lg:w-4/6 overflow-hidden">
    ...
    <div class="pt-6 w-full shadow-2xl">
      ...
      <div class="card-body pt-0">
        ...
        <form @submit.prevent="uploadImage" :class="parseInt(limit_left) <= 0 ? 'disabledArea' : ''">
...
export default {
  ...
  methods: {
    ...
    uploadImage() {
      this.uploading = true;
      axios.post('/upload-image', this.form, {
        onUploadProgress: function (progressEvent) {
          ...
          .then(({data}) => {
            ...
            this.form = {title: null, description: null, image: null, categories: [], languages: []};
            this.getUploadInfo();
